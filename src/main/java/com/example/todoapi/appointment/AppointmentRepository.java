...
public interface AppointmentRepository extends JpaRepository<Appointment, Long> {
    ...
    @Query("SELECT new com.example.todoapi.appointment.AppointmentStats(" +
            "COUNT(a), " +
            ...
            "FROM Appointment a")
    com.example.todoapi.appointment.AppointmentStats getAppointmentStats(@Param("now") LocalDate now);
