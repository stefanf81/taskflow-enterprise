...
> **Historical, point-in-time artifact.** Findings reflect `.github/workflows/`
> as of 2026-08-20. Some have since been resolved (inline `(resolved)` notes) and
> others remain open; this document is kept for provenance, not as a live
> status board.

Scope: all workflows in `.github/workflows/`, related build configuration,
Dockerfiles, scanner configuration, and current package/artifact behavior. No
workflow changes were made as part of this audit.
